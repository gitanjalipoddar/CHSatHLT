...
def plotting(hist1,hist2,i):
    ...
    #not normalising efficiency and number plots
    if i.startswith("effic"):
        N1=1.0
        N2=1.0
...
#extra plot for efficPt with x-axis 0-50

hist1=f_offline.Get("DQMData/Run 1/Tracking/Run summary/Track/general_trackingParticleRecoAsssociation/efficPt")
hist2=f_online.Get("DQMData/Run 1/Tracking/Run summary/Track/general_trackingParticleRecoAsssociation/efficPt")
...
fig.suptitle("efficPt")

fig.set_size_inches(7, 9)
plt.savefig("efficPt50.png")
plt.close()  
